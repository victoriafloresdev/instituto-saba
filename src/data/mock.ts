...
export const audicoesMock = [
  ...
  },
  {
    id: "A-005",
    nome: "Camila Rocha",
    modalidade: "Dança afro-brasileira",
    cidade: "Belo Horizonte",
    idade: 24,
    status: "Contatado",
    data: "14/03/2026",
...
export const patrocinadoresMock = [
  {
    id: "P-001",
    nome: "Máquinas Bolbi Ltda.",
    empresa: "Máquinas Bolbi Ltda.",
    tipo: "Patrocínio master",
    valor: "—",
    status: "Patrocinador citado no PDF",
    data: "—",
  },
];
...
export const escolasMock = [
  {
    id: "E-001",
    escola: "EM Prof. Anísio Teixeira",
