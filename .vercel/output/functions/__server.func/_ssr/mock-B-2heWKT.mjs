//#region node_modules/.nitro/vite/services/ssr/assets/mock-B-2heWKT.js
var programacao = [{
	id: "1",
	data: "Setembro · 2026",
	hora: "Em breve",
	local: "Belo Horizonte · MG",
	titulo: "Ballet Dom Quixote",
	descricao: "Remontagem do clássico do ballet de repertório, com seleção pública de elenco e convidados de renome internacional.",
	tipo: "Espetáculo"
}, {
	id: "2",
	data: "Setembro · 2026",
	hora: "Em breve",
	local: "Belo Horizonte · MG",
	titulo: "Sessão para escolas públicas",
	descricao: "Contrapartida social com espetáculo exclusivo para crianças de escolas públicas, incluindo transporte e lanche.",
	tipo: "Ação social"
}];
var elenco = [
	{
...
//#endregion
export { programacao as n, elenco as t };
