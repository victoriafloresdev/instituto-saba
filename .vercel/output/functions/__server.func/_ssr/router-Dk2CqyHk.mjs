...
import { S as Instagram, f as MessageCircle, h as Mail, n as X, p as Menu, t as Youtube } from "../_libs/lucide-react.mjs";
...
import { t as Route$14 } from "./admin.registro._tipo._id-Bxd0YhXl.mjs";
import { t as Route$15 } from "./espetaculo._slug-BeJ-rV4M.mjs";
import { t as Route$16 } from "./patrocinadores-CTHPHLsP.mjs";
import { t as Route$17 } from "./programacao-9krtUaM_.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dk2CqyHk.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-C4u9fMzD.css";
...
var $$splitComponentImporter$12 = () => import("./sobre-DuBSr17Z.mjs");
...
var $$splitComponentImporter$10 = () => import("./patrocinio-aou1dvX-.mjs");
var Route$10 = createFileRoute("/patrocinio")({
...
var $$splitComponentImporter$9 = () => import("./escolas-Ew120mTJ.mjs");
var Route$9 = createFileRoute("/escolas")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$8 = () => import("./elenco-omF3MTHW.mjs");
var Route$8 = createFileRoute("/elenco")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$7 = () => import("./contato-C7YXLlUt.mjs");
var Route$7 = createFileRoute("/contato")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$6 = () => import("./audicoes-Crc8_OQ7.mjs");
var Route$6 = createFileRoute("/audicoes")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$5 = () => import("./routes-Cu1_HBT1.mjs");
...
var $$splitComponentImporter$4 = () => import("./espetaculo.index-DV6MgCOW.mjs");
var Route$4 = createFileRoute("/espetaculo/")({
	head: () => ({ meta: [{ title: "Espetáculos — Instituto Cultural Sabá" }, {
		name: "description",
		content: "Informações sobre os espetáculos do Instituto Cultural Sabá."
	}] }),
	loader: async () => {
		const spectacles = await fetchPublishedSpectacles();
		if (spectacles.length > 0) throw redirect({
			to: "/espetaculo/$slug",
			params: { slug: spectacles[0].slug }
		});
		return null;
	},
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./admin.index-MCpzqgqk.mjs");
...
var $$splitComponentImporter$2 = () => import("./admin.redefinir-senha-CauQl6w3.mjs");
var Route$2 = createFileRoute("/admin/redefinir-senha")({
	head: () => ({ meta: [{ title: "Definir nova senha — Instituto Cultural Sabá" }, {
		name: "robots",
		content: "noindex,nofollow"
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./admin.recuperar-senha-CHA_-mLi.mjs");
var Route$1 = createFileRoute("/admin/recuperar-senha")({
	head: () => ({ meta: [{ title: "Recuperar senha — Instituto Cultural Sabá" }, {
		name: "robots",
		content: "noindex,nofollow"
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./admin.dashboard-BzHmOvVM.mjs");
...
var ProgramacaoRoute = Route$17.update({
	id: "/programacao",
	path: "/programacao",
	getParentRoute: () => Route$13
});
var PatrocinioRoute = Route$10.update({
	id: "/patrocinio",
	path: "/patrocinio",
	getParentRoute: () => Route$13
});
var PatrocinadoresRoute = Route$16.update({
	id: "/patrocinadores",
	path: "/patrocinadores",
	getParentRoute: () => Route$13
});
var EscolasRoute = Route$9.update({
	id: "/escolas",
	path: "/escolas",
	getParentRoute: () => Route$13
});
var ElencoRoute = Route$8.update({
	id: "/elenco",
	path: "/elenco",
	getParentRoute: () => Route$13
});
var ContatoRoute = Route$7.update({
	id: "/contato",
	path: "/contato",
	getParentRoute: () => Route$13
});
var AudicoesRoute = Route$6.update({
	id: "/audicoes",
	path: "/audicoes",
	getParentRoute: () => Route$13
});
...
var EspetaculoIndexRoute = Route$4.update({
	id: "/espetaculo/",
	path: "/espetaculo/",
	getParentRoute: () => Route$13
});
...
var EspetaculoSlugRoute = Route$15.update({
	id: "/espetaculo/$slug",
	path: "/espetaculo/$slug",
	getParentRoute: () => Route$13
});
var AdminRedefinirSenhaRoute = Route$2.update({
	id: "/admin/redefinir-senha",
	path: "/admin/redefinir-senha",
	getParentRoute: () => Route$13
});
var AdminRecuperarSenhaRoute = Route$1.update({
...
var rootRouteChildren = {
	...
	AdminRecuperarSenhaRoute,
	AdminRedefinirSenhaRoute,
	EspetaculoSlugRoute,
	AdminIndexRoute,
	EspetaculoIndexRoute,
